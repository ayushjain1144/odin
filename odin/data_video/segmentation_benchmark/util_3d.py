...
class Instance(object):
    ...
    def __init__(self, mesh_vert_instances, instance_id, multiplier):
    ...
    def get_label_id(self, instance_id):
        return int(instance_id // self.multiplier)
...
def get_instances(ids, class_ids, class_labels, id2label, multiplier):
    instances = {}
    ...
    for id in instance_ids:
        if id == 0:
            continue
        inst = Instance(ids, id, multiplier)
