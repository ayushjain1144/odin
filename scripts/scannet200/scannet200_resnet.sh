...
OMP_NUM_THREADS=8 CUDA_VISIBLE_DEVICES=0,1 python train_odin.py  --dist-url='tcp://127.0.0.1:6578' --num-gpus 2 --config-file configs/scannet_context/3d.yaml \
OUTPUT_DIR /projects/katefgroup/language_grounding/bdetr2/arxiv_reproduce/scannet_resnet200 SOLVER.IMS_PER_BATCH 4 \
...
SCANNET_DATA_DIR '/projects/katefgroup/language_grounding/mask3d_processed/scannet200/train_validation_database.yaml' \
HIGH_RES_SUBSAMPLE True 

# MODEL.WEIGHTS '/projects/katefgroup/language_grounding/odin_arxiv/m2f_coco.pkl' \
# reduce lr at 52k iterations to 1e-5 and get the best checkpoint at 5k
