...
OUTPUT_DIR /projects/katefgroup/language_grounding/bdetr2/arxiv_reproduce/ablation_scannet_no_interleave SOLVER.IMS_PER_BATCH 6 \
...
MODEL.CROSS_VIEW_BACKBONE False \
