...
OMP_NUM_THREADS=8 CUDA_VISIBLE_DEVICES=0,1 python train_odin.py  --dist-url='tcp://127.0.0.1:9121' --num-gpus 2  --resume --config-file configs/scannet_context/3d.yaml \
OUTPUT_DIR /projects/katefgroup/language_grounding/bdetr2/arxiv_reproduce/ablation_scannet_no_pretrain SOLVER.IMS_PER_BATCH 6 \
...
# MODEL.WEIGHTS '' \
# reduce lr at 100k iterations to 1e-5, get the best checkpoint at  iterations
